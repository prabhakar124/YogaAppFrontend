  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative w-full max-w-md rounded-lg shadow-xl p-6"
        style={{
          backgroundColor: 'var(--color-card)', // ✅ Use CSS variable
          color: 'var(--color-foreground)', // ✅ Use CSS variable
        }}>
        {/* Close Button */}
        <button
          onClick={() => {
          ...
          style={{ color: 'var(--color-muted-foreground)' }} // ✅ Theme color
        >
        ...
        {view === "signin" && (
          <>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: 'var(--color-input)', // ✅ Theme color
                    borderColor: 'var(--color-border)', // ✅ Theme color
                    color: 'var(--color-foreground)', // ✅ Theme color
                  }}
                  required
                />
              </div>
            ...
            <div className="mt-4 space-y-3">
              <button className="w-full flex items-center justify-center gap-3 border border-gray-300 py-2 px-4 rounded-md hover:bg-gray-50 transition-colors">
